...
')
     ...
     */ 
        ...
        {
                        return \Voerro\FileUploader\FileUploader::make($file);
        }
                    /**
        ...
        {
                        /** @var \Voerro\FileUploader\FileUploader $instance */
         ...
         * @static 
         */ 
        public static function upload($path = '', $storage = 'public')
        {
                        /** @var \Voerro\FileUploader\FileUploader $instance */
                        return $instance->upload($path, $storage);
        }
                    /**
         ...
         * @static 
         */ 
        public static function uploadAs($filename, $path = '', $storage = 'public')
        {
                        /** @var \Voerro\FileUploader\FileUploader $instance */
                        return $instance->uploadAs($filename, $path, $storage);
        }
                    /**
         ...
         * @static 
         */ 
        public static function replace($oldFilePath, $path = '', $storage = 'public')
        {
                        /** @var \Voerro\FileUploader\FileUploader $instance */
                        return $instance->replace($oldFilePath, $path, $storage);
        }
                    /**
         ...
         * @static 
         */ 
        public static function replaceAs($oldFilePath, $newFilename, $path = '', $storage = 'public')
        {
                        /** @var \Voerro\FileUploader\FileUploader $instance */
                        return $instance->replaceAs($oldFilePath, $newFilename, $path, $storage);
        }
                    /**
         ...
         * @static 
         */ 
        public static function downsize($maxWidth, $maxHeight)
        {
                        /** @var \Voerro\FileUploader\FileUploader $instance */
                        return $instance->downsize($maxWidth, $maxHeight);
        }
                    /**
         ...
         * @static 
         */ 
        public static function fit($width, $height, $dontUpsize = false)
        {
                        /** @var \Voerro\FileUploader\FileUploader $instance */
                        $instance->fit($width, $height, $dontUpsize);
        }
                    /**
        ...
        {
                        \Voerro\FileUploader\FileUploader::delete($filePath, $storage);
        }
                    /**
        ...
        {
                        return \Voerro\FileUploader\FileUploader::isImage($file, $storage);
        }
...
namespace  { 
            ...
            class FileUploader extends \Voerro\FileUploader\FileUploaderFacade {}
