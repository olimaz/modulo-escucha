...
/**
 * @property int $id_entrevista_profundidad_violencia_victima
 ...
 */
class entrevista_profundidad_violencia_victima extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'esclarecimiento.entrevista_profundidad_violencia_victima';
     ...
     * @var string
     */
    protected $primaryKey = 'id_entrevista_profundidad_violencia_victima';
