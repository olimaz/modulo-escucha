...
class excel_dcExport implements FromCollection, WithHeadings, WithTitle, WithEvents, WithStrictNullComparison
{
    ...
    {
        //
        $listado = excel_dc::selectRaw(\DB::raw('excel_dc.*'))->wherein('id_diagnostico_comunitario',$this->arreglo)->orderby('id_diagnostico_comunitario')->get();
        //Ocultar columnas
