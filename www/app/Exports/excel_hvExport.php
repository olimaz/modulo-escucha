...
class excel_hvExport implements FromCollection, WithHeadings, WithTitle, WithEvents, WithStrictNullComparison
{
    ...
    {
        //
        $listado = excel_hv::selectRaw(\DB::raw('excel_hv.*'))->wherein('id_historia_vida',$this->arreglo)->orderby('id_historia_vida')->get();
        //Ocultar columnas
