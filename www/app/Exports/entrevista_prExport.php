...
class entrevista_prExport implements FromCollection, WithHeadings, WithStrictNullComparison, WithColumnFormatting, WithTitle, WithEvents
{
    ...
    */
    public function collection()
    {
        ...
        $listado = excel_entrevista_pr::selectRaw(\DB::raw('excel_entrevista_pr.*'))->permisos()->orderby('correlativo')->get();
