...
class excel_ee_filtradoExport implements FromCollection, WithHeadings, WithTitle, WithEvents, WithStrictNullComparison
{
    ...
    */
    ...
    {
        //
        $listado = excel_sujeto_colectivo::selectRaw(\DB::raw('excel_sujeto_colectivo.*'))->wherein('id_entrevista_etnica',$this->arreglo)->orderby('id_entrevista_etnica')->get();
        //Ocultar columnas
