...
class entrevistaExport implements FromCollection, WithHeadings, WithStrictNullComparison, WithColumnFormatting, WithTitle, WithEvents
{
    ...
    public function collection()
    {
        ...
        $listado = excel_entrevista::selectRaw(\DB::raw('excel_entrevista_fvt.*'))->permisos()->orderby('codigo_entrevista')->get();
