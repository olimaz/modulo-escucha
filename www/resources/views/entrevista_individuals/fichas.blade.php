        ...
        <div class="col-sm-12">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    @else
                        <div class="text-yellow text-center">
                            ...
                            No se ha especificado la información del consentimiento informado
                        </div>
                    @endif
                </div>
                @if(isset($no_editar))
                ...
                <div class="box-footer text-center">
                    ...
                    @else
                        <a href="{{ action('f_entrevistaController@create')."?id_e_ind_fvt=".$expediente->id_e_ind_fvt }}" class="btn btn-success">Completar esta sección</a>
                    @endif
                </div>
                @endif
            </div>
    ...
    @if(isset($no_editar))
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="box">
                    <div class="box-body">
                        <span class="text-bold">Síntesis del relato:</span>  {!!  nl2br($expediente->fmt_sintesis_relato)!!}
                    </div>
                </div>
            </div>
