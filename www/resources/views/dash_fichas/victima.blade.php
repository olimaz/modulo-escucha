...
<div class="col-sm-6">
    @include("dash_fichas.p_grafico",
                 ['info_titulo' => 'Departamento de nacimiento'
                    , 'info_pie' => "Información para un total de ". $datos->victima->total ." personas con fichas diligenciadas digitalmente."
...
<div class="col-sm-6">
    <div class="box box-solid box-primary">
        ...
        <div class="box-footer">
            <span class="text-muted">Información para un total de {{ $datos->victima->total }} personas con fichas diligenciadas digitalmente.</span>
        </div>
...
@push("js")
    ...
    <script>
        ...
        function actualizar_graficos_victima(json) {
            ...
            actualizar_tabla("t_g_victima_edad",json.edad, enlace_base+'?vi_id_grupo_etario=');
            //Pertenencia etinca
