...
<div class="box box-success ">
    <div class="box-header">
        <h3 class="box-title text-success"> Información de la primera salida</h3>
        <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse" id="btn_box_salida"><i class="fa fa-minus"></i>
            </button>
        </div>
    </div>
...
<div class="box box-success ">
    <div class="box-header">
        <h3 class="box-title text-success">Información de reasentamientos posteriores</h3>
        <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse" id="btn_box_reas"><i class="fa fa-minus"></i>
            </button>
        </div>
    </div>
    <div class="box-body no-padding">
...
<div class="box box-success ">
    <div class="box-header">
        <h3 class="box-title text-success">Información del retorno</h3>
        <div class="box-tools pull-right">
...
<div class="box box-success ">
    <div class="box-header">
        <h3 class="box-title text-success">Impactos y afrontamientos</h3>
        <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse" id="btn_box_ret"><i class="fa fa-minus"></i>
            </button>
        </div>
