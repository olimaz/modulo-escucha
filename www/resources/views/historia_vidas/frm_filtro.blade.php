<?php
    ...
    if(!isset($filtros)) {
        $filtros = \App\Models\historia_vida::filtros_default();
    }
?>
...
<div class="box box-default box-solid collapsed-box">
    ...
    <div class="box-body">
        ...
        {{-- Fila 1: fecha y lugar de la entrevista --}}
        <div class="row">
            <div class="col-md-2 ">
                <div class="form-group">
        ...
        <hr>
        {{-- Objetivo, Nombres, apellidos --}}
        <div class="row">
            <div class="col-md-3 ">
                @include('controles.autofill', ['control_control' => 'titulo'
                                         ,'control_url' => 'autofill/hv_titulo'
            ...
            <div class="col-md-3 ">
                @include('controles.autofill', ['control_control' => 'entrevista_objetivo'
                                         ,'control_url' => 'autofill/hv_entrevista_objetivo'
            ...
            <div class="col-md-3">
                @include('controles.autofill', ['control_control' => 'entrevistado_nombres'
                                       ,'control_url' => 'autofill/hv_nombres'
                                       ,'control_default' => $filtros->entrevistado_nombres
                                       ,'control_resaltar' => true
                                       ,'control_texto'=>'Nombre completo del entrevistado:'])
            </div>
            {{--
            <div class="col-md-3">
                @include('controles.autofill', ['control_control' => 'entrevistado_apellidos'
                                      ,'control_url' => 'autofill/hv_apellidos'
                                      ,'control_default' => $filtros->entrevistado_apellidos
                                      ,'control_texto'=>'Apellidos del entrevistado:'])

            </div>
            --}}
            <div class="col-md-3">
                @include('controles.autofill', ['control_control' => 'entrevistado_otros_nombres'
                                       ,'control_url' => 'autofill/hv_otros_nombres'
                                       ,'control_default' => $filtros->entrevistado_otros_nombres
                                       ,'control_resaltar' => true
        ...
        <div class="row">
            ...
            <div class="col-md-3 ">
                @include('controles.autofill', ['control_control' => 'dinamica'
                                        ,'control_url' => 'autofill/hv_dinamica'
            ...
            <div class="col-md-3 ">
                @include('controles.autofill', ['control_control' => 'observaciones'
                                       ,'control_url' => 'autofill/hv_observaciones'
