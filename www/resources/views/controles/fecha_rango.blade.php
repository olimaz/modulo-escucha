...
<div class="form-group">
    ...
    @if($control_requerido)
        {!! Form::text($control_control, $control_default, ['class' => 'form-control dateRange','required'=>'required']) !!}
    @else
        {!! Form::text($control_control, $control_default, ['class' => 'form-control dateRange']) !!}
    @endif
</div>
