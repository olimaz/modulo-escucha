...
Control tipo texto.  Se sobresalta cuando es usado con el parametro $control_resaltar
...
@php
    ...
    if($control_resaltar) {
        $clase_resaltar = empty($control_default) ? "" :" has-success text-success  " ;  //is-valid: es para bootstrap4
    }
