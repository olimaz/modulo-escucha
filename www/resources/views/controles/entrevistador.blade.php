...
<div class="form-group  {{ $errors->has($control_control) ? 'has-error' :'' }} {{ $texto_resaltar }}">
    ...
    {!! Form::select($control_control, \App\Models\entrevistador::listado_items($control_vacio,$control_mi_mismo,$control_deshabilitados,$control_confidenciales), $control_default,$opciones) !!}
