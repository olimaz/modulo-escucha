...
@endsection
@section('content')
        <h1 class="pull-left">Asignación de transcripciones <small>Cuadro de resumen</small></h1>
        {{--
        <h1 class="pull-right">
                ...
                <table class="table table-condensed table-striped" id="t_cuadro_resumen">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Tiempo transcrito <br>(horas:minutos)</th>
                            <th class="text-center">Tiempo promedio <br> por entrevista</th>
                        </tr>
                    </thead>
                    <tbody>
                        @php($i=1)
