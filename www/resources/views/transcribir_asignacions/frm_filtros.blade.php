...
<div class="box box-default  box-solid">
    <div class="box-header ">
        <h3 class="box-title"><i class="fa fa-filter" aria-hidden="true"></i> Asignaciones: Filtrar la informaci&oacute;n visualizada</h3>
    ...
    <div class="box-body">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                @include('controles.catalogo', ['control_control' => 'id_causa'
                                                    ...
                                                    , 'control_vacio' => 'Mostrar todos'
                                                    ,'control_texto'=>'No transcrito por:'])
            </div>
            <div class="col-md-4 ">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-xs-6 ">
                <a href="{{ action('transcribir_asignacionController@index') }}" class="btn btn-default">Quitar filtros y mostrar todo</a>
            </div>
            <div class="col-xs-6">
