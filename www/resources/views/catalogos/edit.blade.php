        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        @include('controles.radio_si_no', ['control_control' => 'pendiente_revisar'
                                                           ,'control_opciones'=> [1=>"Sí", 2=>"No", 3=>"Revisado"]
                                                           , 'control_default'=>$item->pendiente_revisar
                                                           ,'control_texto'=>'Pendiente de revisar:'
                                                           ])
                    </div>
