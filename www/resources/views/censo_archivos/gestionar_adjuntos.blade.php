...
@section('content_header')
    ...
    <h1 class="page-title">
        Gestión de archivos adjuntos,  Registro de archivos en el exilio <a href="{{ action("censo_archivosController@show",$censoArchivo->id_censo_archivos) }}"> {!! $censoArchivo->entrevista_codigo !!} </a>
    </h1>
@endsection
...
@section('content')
    ...
    <div class="box box-primary box-solid">
        <div class="box-header ">
            <h3 class="box-title"> Adjuntar archivos al registro de archivos en el exilio</h3>
        </div>
        <div class="box-body">
            {!! Form::open(['action' => 'censo_archivosController@crear_adjunto','id'=>'frm_adjunto','files' => true]) !!}
                {!! Form::hidden('id_censo_archivos',$censoArchivo->id_censo_archivos) !!}
