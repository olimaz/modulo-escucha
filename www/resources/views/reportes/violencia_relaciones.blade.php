...
@section('content_header')
    <h1 class="page-header">Relaciones entre términos</h1>
...
@section('content')
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Uso del tesauro como ejemplo</h3>
        </div>
...
@push("js")
    ...
    <script>
        console.log({!! $json_entidades !!} );
        console.log({!! $json_relaciones !!} );

        var json_entidades = {!! $json_entidades !!};
        var json_relaciones = {!! $json_relaciones !!};
