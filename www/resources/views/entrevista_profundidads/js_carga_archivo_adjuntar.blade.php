...
@push('js')
    ...
    <script>
        ...
        function upload(img) {
            ...
            form_data.append('id_expediente',{{ $entrevistaProfundidad->id_entrevista_profundidad }});
            var inicio = new Date();
            var final = new Date();
        ...
        function actualizar_tabla() {
            $.ajax({
                url: " {{ url("/tabla_adjuntos_pr/".$entrevistaProfundidad->id_entrevista_profundidad) }} ",
                type: 'GET',
                success: function (data) {
