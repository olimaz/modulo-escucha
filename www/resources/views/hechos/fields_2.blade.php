<div class="form-group col-sm-4">
    <br>
    {!! Form::label('cantidad_victimas', 'Cantidad total de víctimas que sufrieron este hecho:') !!}
    <div class="row col-sm-6">
        {!! Form::number('cantidad_victimas', null, ['class' => 'form-control', 'required'=>'required', 'min'=>1]) !!}
    </div>
...
<div class="form-group col-sm-8">
    @include('controles.geo3', ['control_control' => 'id_lugar'
                                ...
                                ,'control_vacio' => '(No sabe / No responde)'
...
<div class="form-group col-sm-8">
    ...
    {!! Form::text('sitio_especifico', null, ['class' => 'form-control','maxlength'=>200]) !!}
</div>
...
@push('js')
    <script>
        $("#frm_abc_hecho").submit(function( event ) {
            if ( $("#id_lugar_depto").val() > 0 ) {
                return;
            }
            alert("Por favor, indique como mínimo el departamento en que ocurrieron de los hechos.");
