        ...
        <div class="row">
            <div class="col-md-3 ">
                @include('controles.autofill', ['control_control' => 'titulo'
                                         ,'control_url' => 'autofill/co_titulo'
            ...
            <div class="col-md-3 ">
                @include('controles.autofill', ['control_control' => 'tema_descripcion'
                                         ,'control_url' => 'autofill/co_tema_descripcion'
            ...
            <div class="col-md-3 ">
                @include('controles.autofill', ['control_control' => 'tema_objetivo'
                                         ,'control_url' => 'autofill/co_tema_objetivo'
            ...
            <div class="col-md-3 ">
                @include('controles.autofill', ['control_control' => 'eventos_descripcion'
                                        ,'control_url' => 'autofill/co_eventos_descripcion'
        ...
        <div class="row">
            <div class="col-md-3 ">
                @include('controles.autofill', ['control_control' => 'dinamica'
                                        ,'control_url' => 'autofill/co_dinamica'
            ...
            <div class="col-md-3 ">
                @include('controles.autofill', ['control_control' => 'observaciones'
                                       ,'control_url' => 'autofill/co_observaciones'
