<div class="row">
    ...
    <div class="col-sm-6">
        @include("fichas.stats.p_tabla",
                   ['info_titulo' => $datos->entrevistada->organizacion->descripcion
                      , 'info_tabla' =>  $datos->entrevistada->organizacion
                      , 'tabla_nombre' => 'pe_organizacion'
...
@push("js")
    ...
    <script>
        ...
        function actualizar_graficos_entrevistada(json) {
            ...
            actualizar_tabla("t_g_entrevistada_edad",json.edad);
            //Pertenencia etinca
