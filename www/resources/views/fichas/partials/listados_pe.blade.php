{{-- Para escoger el listado a mostrar --}}
    <div class="btn-group btn-group-toggle" data-toggle="buttons">
        <label class="btn btn-primary {{ $filtros->id_tipo_listado==1 ? ' active ' : '' }}"  title="Muestra datos de las personas entrevistadas" data-toggle="tooltip">
            <input type="radio" name="options" id="option_a1" autocomplete="off" onclick="cambiar_tipo_listado(1)"  {{ $filtros->id_tipo_listado==1 ? ' checked="" ' : '' }} > Mostrar listado de personas entrevistadas
        </label>
