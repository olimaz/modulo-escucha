...
<div class="card collapsed-card   {{ $filtros->hay_filtro >0 ? ' card-success' : ' card-info ' }}">
    ...
    <div class="card-body text-sm">
        <div class="row">
            <div class="w-100"></div>
            <p class="text-info text-bold">Filtros según metadatos de la entrevista</p>
            <div class="w-100"></div>
            ...
            <div class="w-100"></div>
            <p class="text-info text-bold">Filtros según datos de la violencia</p>
            <div class="w-100"></div>
            ...
            <p class="text-info text-bold">Filtros según datos de la víctima</p>
            <div class="w-100"></div>

            <div class="col-md-3">
                @include('controles.catalogo', ['control_control' => 'vi_id_sexo'
                                      ,'control_default' => $filtros->vi_id_sexo
                                      ,'control_id_cat' => 24
                                      ,'control_vacio' => "[Mostrar todos]"
                                      ,'control_resaltar' => true
            ...
            <div class="col-md-3">
                @include('controles.catalogo', ['control_control' => 'id_etnia'
                                        ,'control_default' => $filtros->vi_id_etnia
                                        ,'control_id_cat' => 27
            ...
            <div class="col-md-3">
                <div class="row">
                    <div class="col">
                        @include('controles.numero', ['control_control' => 'vi_edad_del'
                                               , 'control_default'=>$filtros->vi_edad_del
                                               ,'control_resaltar' => true
                                               ,'control_requerido' => false
                                               ,'control_texto'=>'Edad mínima:'])
                    </div>
                    <div class="col">
                        @include('controles.numero', ['control_control' => 'vi_edad_al'
                                              , 'control_default'=>$filtros->vi_edad_al
                                              ,'control_resaltar' => true
                                              ,'control_requerido' => false
