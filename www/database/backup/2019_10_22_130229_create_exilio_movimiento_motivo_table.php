...
class CreateExilioMovimientoMotivoTable extends Migration
{
    /**
     * Run the migrations.
     *
     ...
     */
    var $esquema="fichas";
    var $tabla="exilio_movimiento_motivo";
    public function up()
    {
        Schema::create($this->esquema.".".$this->tabla, function (Blueprint $table) {
            $table->increments('id_exilio_movimiento_motivo');
            ...
            $table->foreign('id_motivo')->references('id_item')->on('catalogos.cat_item')
    ...
    public function down()
    {
        ...
        Schema::dropIfExists($this->esquema.".exilio_motivo");
    }
}
