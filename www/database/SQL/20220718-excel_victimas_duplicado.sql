...
comment on column analitica.victima.id_duplicado is 'las victimas que comparten el mismo número, son duplicadas';
...
create index if not exists victima_codigo_entrevista_index
