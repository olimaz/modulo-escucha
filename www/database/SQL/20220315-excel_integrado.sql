...
create table if not exists esclarecimiento.excel_entrevista_integrado
(
    id serial
    ...
    a_casos_informes integer default 0,
    a_otros integer default 0,
    a_autorizaciones integer default 0,
    a_referencias integer default 0,
    a_comunicacion_oficial integer default 0,
    a_plan_trabajo integer default 0,
    a_valoracion integer default 0,
    a_certificaciones integer default 0,
    a_certificacion_inicial integer default 0,
    a_certificacion_final integer default 0,
    a_evaluacion_vulnerabilidad integer default 0,
    a_evaluacion_seguridad integer default 0,
    a_retroalimentacion integer default 0,
    a_otranscribe integer default 0,
    a_total_adjuntos integer default 0,
    ...
    entrevistada_nombres text,
    entrevistada_apellidos text,
    entrevistada_sexo text,
    entrevistada_edad text,
    entrevistada_es_victima text,
    entrevistada_es_testigo text,
    fecha_carga text,
    mes_carga text,
    fecha_cierre text,
    mes_cierre text,
    max_fecha_adjunto text,
    max_mes_adjunto text,
    id_entrevistador integer
);

alter table esclarecimiento.excel_entrevista_integrado owner to dba;

create index if not exists excel_entrevista_integrado_codigo_entrevista_index
    on esclarecimiento.excel_entrevista_integrado   (codigo_entrevista);

create index if not exists excel_entrevista_integrado_id_entrevistador_index
...
create table if not exists esclarecimiento.excel_entrevista_pr
(
...
create index if not exists excel_entrevista_pr_entrevista_index
    on esclarecimiento.excel_entrevista_pr (codigo_entrevista);

create index if not exists excel_entrevista_pr_id_entrevistador_index
