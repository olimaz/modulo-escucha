-- Nuevos actores armados, hay que modifcar el excel
UPDATE "catalogos"."cat_item" SET "otro" = 'aa_otro_actor' WHERE "id_item" = 146;
UPDATE "catalogos"."cat_item" SET "otro" = 'aa_otro_grupo_armado' WHERE "id_item" = 51;
UPDATE "catalogos"."cat_item" SET "otro" = 'aa_internacional' WHERE "id_item" = 145;
UPDATE "catalogos"."cat_item" SET "otro" = 'aa_otro_agente_estado' WHERE "id_item" = 144
UPDATE "catalogos"."cat_item" SET "otro" = 'aa_ns_nr' WHERE "id_item" = 147;
