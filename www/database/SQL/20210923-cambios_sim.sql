...
comment on column sim.entrevista_victima.tipo_recurso is 'Texto predefinido con el nombre de la persona entrevistada';
...
comment on column sim.entrevista_victima.consentimiento_informado is 'JSON con respuestas del consentimiento informado';
