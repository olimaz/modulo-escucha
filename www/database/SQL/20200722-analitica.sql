...
ALTER SCHEMA analitica OWNER TO dba;
GRANT USAGE ON SCHEMA analitica TO solo_lectura;
...
(
	...
	clasificacion_nivel integer default -99,
	...
	-- ficha de entrevista
	id_ficha_entrevista integer default -99,
	idioma_id integer default -99,
	idioma_txt text,
	idioma_nativo_id integer default -99,
	idioma_nativo_txt text,
	nombre_interprete text,
	documentacion_aporta integer default -99,
	documentacion_especificar text,
	identifica_testigos integer default -99,
	ampliar_relato integer default -99,
    ...
    -- Prioridad
    id_prioridad    integer default -99,
	prioridad_tipo  text ,
